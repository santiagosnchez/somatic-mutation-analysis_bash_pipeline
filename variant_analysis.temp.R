...
somaticmafpath <- paste0(current_dir, "/vcf/", args[2], ".mutect2.all.Somatic.annotated-funcotator.",args[1],".vcf.gz")
germlinemafpath <- paste0(current_dir, "/vcf/", args[2], ".varscan.all.Germline.annotated-funcotator.",args[1],".vcf.gz")

# make/read vcf as maf
maf.som <- read_vcf(somaticmafpath)

# make/read vcf as maf
#maf.ger <- read_vcf(germlinemafpath)
